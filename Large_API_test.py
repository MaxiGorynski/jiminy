#tutorial here https://www.youtube.com/watch?v=GMppyAPbLYk
...
video_update_args.add_argument("views", type=int, help="Number of video views is required")
video_update_args.add_argument("likes", type=int, help="Number of video likes is required")
...
class Video(Resource):
    ...
    def get(self, video_id):
        ...
        if not result:
            abort(404, message="Could not find arse.")
        return result
